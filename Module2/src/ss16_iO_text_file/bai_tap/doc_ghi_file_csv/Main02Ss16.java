...
public class Main02Ss16 {
    ...
    private static final String FILE_GOT_DATA = "src/ss16_iO_text_file/bai_tap/doc_ghi_file_csv/File_TakeData.csv";
    public static void main(String[] args) {
        ...
        readAndWrite.writeCountryListToCsvFile(FILE_GOT_DATA,countryList,false);
    }
}
