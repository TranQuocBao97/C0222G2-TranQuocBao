...
import bai_tap_lam_them_oop_1.model.sub_vehicle.Car;
import bai_tap_lam_them_oop_1.service.notImplement.CompanyListService;
import bai_tap_lam_them_oop_1.service.InterfaceCarService;
...
public class CarServiceImplement implements InterfaceCarService{
    ...
    static{
        ...
        carList.add(new Car (11001,new CompanyListService().company(2),2021,"Đinh La Lúc",4,"Gia đình"));
    }
    ...
    public boolean search(int id) {
        for(Car car : carList){
            String carString = Integer.toString(car.getIdControl());
            String idString = Integer.toString(id);
            if(carString.contains(idString)){
                System.out.println(car);
                return true;
            }
        }
