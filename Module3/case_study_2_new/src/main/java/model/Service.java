...
public class Service {
    ...
    public Service(Integer serviceId, String serviceName, Double serviceArea, Double serviceCost, Integer serviceMaxPeople,
                   String serviceStandardRoom, String serviceDescription, Double servicePoolArea, Integer serviceNumberFloor,
                   model.RentType rentType, ServiceType serviceType) {
        this.serviceId = serviceId;
